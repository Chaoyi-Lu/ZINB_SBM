...
The concaveness of the log $\boldsymbol{Y}\_{gh}$ term of the ICPCL with respect to the $r_{gh}$ can be checked by the function `Directed_ZINBSBM_ApproximateICPCL_logY_gh_term_CheckConcave()` provided in [`Functions_for_ZINB_SBM.R`].
